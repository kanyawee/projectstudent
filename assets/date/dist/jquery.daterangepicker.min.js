...
!function(e) {
    ...
    e.dateRangePickerLanguages = {"default": {
            selected: "เลือกวันที่:",
            day: "Day",
            days: "วัน",
            apply: "Close", "week-1": "จ", "week-2": "อ", "week-3": "พ", "week-4": "พฤ", "week-5": "ศ", "week-6": "ส", "week-7": "อา", "week-number": "W",
            "month-name": ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"],
            shortcuts: "Shortcuts",
        ...
        function r() {
            ...
            if (ne(m), a.time.enabled)
                if (a.startDate && a.endDate || a.start && a.end)
                    P(t(a.start || a.startDate).toDate(), "time1"), P(t(a.end || a.endDate).toDate(), "time2");
                else {
            ...
            h = te(a.singleDate ? "default-single" : a.minDays && a.maxDays ? "default-range" : a.minDays ? "default-more" : a.maxDays ? "default-less" : "default-default"), re.find(".default-top").html(h.replace(/\%d/, a.minDays).replace(/\%d/, a.maxDays)), a.singleMonth ? re.addClass("single-month") : re.addClass("two-months"), setTimeout(function() {
                ...
                if (n.indexOf("day") != -1) {
                    ...
                    var o;
                    for (o = 1 == t?"monday" == a.startOfWeek?1:0:"monday" == a.startOfWeek?0:6, r = new Date(r.getTime() - 864e5); r.getDay() != o; )
                        r = new Date(r.getTime() + 864e5 * t);
                    s = new Date(r.getTime() + 864e5 * t * 6)
                } else if (n.indexOf("month") != -1)
                    t = n.indexOf("prev,") != -1 ? -1 : 1, s = 1 == t ? F(r) : H(r), s.setDate(1), r = F(s), r.setDate(1), 
                        r = new Date(r.getTime() - 864e5);
                else if (n.indexOf("year") != -1)
                    t = n.indexOf("prev,") != -1 ? -1 : 1, s = new Date, s.setFullYear(r.getFullYear() + t),
                        s.setMonth(0), s.setDate(1), r.setFullYear(r.getFullYear() + t), r.setMonth(11), r.setDate(31);
                else if ("custom" == n) {
                    var d = e(this).html();
                ...
                var a = t.target, n = "hour" == a.name ? e(a).val().replace(/^(\d{1})$/, "0$1") : void 0, r = "minute" == a.name ? e(a).val().replace(/^(\d{1})$/, "0$1") : void 0;
                p("time1", n, r)
        ...
        function s() {
            if (!a.inline) {
                ...
                if ("relative" == e(a.container).css("position")) {
                    ...
                    t.left < 460 ? re.css({top: t.top + e(de).outerHeight() + parseInt(e("body").css("border-top") || 0, 10), left: t.left}) : re.css({top: t.top + e(de).outerHeight() + parseInt(e("body").css("border-top") || 0, 10), left: t.left + e(de).width() - re.width() - 16})
            }
        }
        function i() {
            return re
        ...
        function d() {
            ...
            if (n && (1 == n.length && a.singleDate || n.length >= 2)) {
                var r = a.format;
                r.match(/Do/) && (r = r.replace(/Do/, "D"), n[0] = n[0].replace(/(\d+)(th|nd|st)/, "$1"),
                n.length >= 2 && (n[1] = n[1].replace(/(\d+)(th|nd|st)/, "$1"))), oe = !1, n.length >= 2 ? T(l(n[0], r, t.locale(a.language)), l(n[1], r, t.locale(a.language))) : 1 == n.length && a.singleDate && j(l(n[0], r, t.locale(a.language))), oe = !0
            }
        }
        function l(e, a, n) {
        ...
        function u() {
            ...
            e && (e = parseInt(e));
            var t = re.find(".month1").width(), a = re.find(".gap").width() + (e ? 2 * e : 0), n = re.find(".month2").width();
        ...
        function w(e) {
            if (e = parseInt(e, 10), a.startDate && L(e, a.startDate) < 0)
                return!1;
            if (a.endDate && L(e, a.endDate) > 0)
                return!1;
            if (a.start && !a.end && !a.singleDate) {
                if (a.maxDays > 0 && O(e, a.start) > a.maxDays)
                    return!1;
                if (a.minDays > 0 && O(e, a.start) < a.minDays)
                    return!1;
        ...
        function D(t) {
            ...
            if (t.hasClass("has-tooltip") && t.attr("data-tooltip"))
                ...
                if (a.singleDate)
                    re.find(".day.hovering").removeClass("hovering"), t.addClass("hovering");
            ...
            if (r) {
                ...
                d += t.width() / 2;
                var u = re.find(".date-range-length-tip"), m = u.css({visibility: "hidden", display: "none"}).html(r).width(), c = u.height();
        ...
        function C(t, n) {
            ...
            var r;
            a.start && a.singleDate ? (re.find(".apply-btn").removeClass("disabled"), r = V(new Date(a.start)), a.setValue.call(le, r, V(new Date(a.start)), V(new Date(a.end))), oe && !n && e(de).trigger("datepicker-change", {value: r, date1: new Date(a.start)})) : a.start && a.end ? (re.find(".selected-days").show().find(".selected-days-num").html(O(a.end, a.start)), re.find(".apply-btn").removeClass("disabled"), r = V(new Date(a.start)) + a.separator + V(new Date(a.end)), a.setValue.call(le, r, V(new Date(a.start)), V(new Date(a.end))), oe && !n && e(de).trigger("datepicker-change", {value: r, date1: new Date(a.start), date2: new Date(a.end)})) : t ? re.find(".apply-btn").removeClass("disabled") : re.find(".apply-btn").addClass("disabled")
        }
        function O(e, t) {
        ...
        function j(e) {
            var t = !0;
            if (a.startDate && L(e, a.startDate) < 0 && (t = !1), a.endDate && L(e, a.endDate) > 0 && (t = !1), !t)
                return void Y(a.startDate, "month1");
        ...
        function Y(e, n) {
            e = t(e).toDate();
            var r = I(e.getMonth());
            re.find("." + n + " .month-name").html(r + " " + e.getFullYear()), re.find("." + n + " tbody").html(Q(e)), a[n] = e, b()
        }
        function P(e, t) {
        ...
        function W() {
            S();
            var e = parseInt(t(a.month1).format("YYYYMM")), n = parseInt(t(a.month2).format("YYYYMM")), r = Math.abs(e - n), s = r > 1 && 89 != r;
        ...
        function q() {
            ...
            a.extraClass && (t += " " + a.extraClass + " "),
                    ...
                    a.customTopBar && (t += " custom-topbar "), t += '">', 
                    a.showTopbar && (t += '<div class="drp_top-bar">',
                    a.customTopBar ? ("function" == typeof 
                    a.customTopBar && (a.customTopBar = a.customTopBar()), t += '<div class="custom-top">' + a.customTopBar + "</div>") : (t += '<div class="normal-top"><span style="color:#333">' + te("selected") + ' </span> <b class="start-day">...</b>', a.singleDate || (t += ' <span class="separator-day">' + a.separator + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + te("days") + ")</i>"),
        ...
        function Q(e) {
            ...
            if (s > 0)
                for (var d = s; d > 0; d--) {
                    ...
                    o = w(l.getTime()), a.startDate && L(l, a.startDate) < 0 && (o = !1), a.endDate && L(l, a.endDate) > 0 && (o = !1), n.push({date: l, type: "lastMonth", day: l.getDate(), time: l.getTime(), valid: o})
                }
            for (var u = e.getMonth(), d = 0; d < 40; d++)
                i = t(e).add(d, "days").toDate(), o = w(i.getTime()), a.startDate && L(i, a.startDate) < 0 && (o = !1), a.endDate && L(i, a.endDate) > 0 && (o = !1), n.push({date: i, type: i.getMonth() == u ? "toMonth" : "nextMonth", day: i.getDate(), time: i.getTime(), valid: o});
            for (var m = [], c = 0; c < 6 && "nextMonth" != n[7 * c].type; c++) {
                ...
                for (var l = 0; l < 7; l++) {
                    ...
                    var v = {time: i.time, "data-tooltip": i.tooltip, "class": "day " + i.type + " " + i.extraClass + " " + (i.valid ? "valid" : "invalid") + " " + (p ? "real-today" : "")};
        ...
        function ee() {
            if ("auto" == a.language) {
                ...
                for (var n in e.dateRangePickerLanguages)
                    if (t.indexOf(n) !== -1)
                        return e.dateRangePickerLanguages[n];
                return e.dateRangePickerLanguages["default"]
            }
        ...
        function te(t) {
            var a = t.toLowerCase(), n = t in ie ? ie[t] : a in ie ? ie[a] : null, r = e.dateRangePickerLanguages["default"];
        ...
        a || (a = {}), a = e.extend(!0, {autoClose: !1, format: "DD-MM-YYYY", separator: " ถึง ", language: "auto", startOfWeek: "sunday", getValue: function() {
                return e(this).val()
            }, setValue: function(t) {
