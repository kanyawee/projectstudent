...
//        print_r($es);
        if ($es != NULL) {
            ...
            $this->load->view('establishment/establishment_formadd', $st_es);
        }
...
//        extract($this->session->userdata());  
    ...
    public function showallestablish() {
        ...
        $data['year'] = $this->control_status->getbyyear();
//        print_r($dataesta);
        $data['establish'] = $this->establishmodel->establishall();
//        print_r($dataesta);
