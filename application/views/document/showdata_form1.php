                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body"> 
                                    <table class="table" id="tabledetail">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><span style="padding-left:40px"><?php echo $address_es ?></span>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td colspan="4">ที่อยู่ : <span style="padding-left:20px"><?php echo $address_home ?>
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">ที่อยู่ : 
                                                    <span style="padding-left:20px"><?php echo $address_contact ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                    ...
                                    <div class="col-lg-offset-5 col-lg-4 ">
                                        <br>
                                        <a href="<?php echo base_url('index.php/Document/form_update'); ?>"><button class="btn btn-primary" type="submit">แก้ไขข้อมูล</button></a>
                                        <a href="<?php echo base_url('index.php/document/menudocument'); ?>"><button class="btn btn-default" type="reset">กลับหน้ารายการ</button></a>
                                    </div>                              
                                </div>
                            </div>
                        </div>
