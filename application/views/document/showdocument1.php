                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1" >
                        ...
                        <ol class="breadcrumb">
                            ...
                            <?php if ($function != 0) { ?>
                                <li class="active">
                                    <i class="fa fa-table"></i><a href="<?php echo base_url('teacher/document'); ?>"> เมนูเอกสาร</a> 
                                </li>
                            <?php }?>
                                <li>
                                    ...
                                    <div class="panel-body"> 
                                        <table class="table" id="tabledetail">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td width="3%"></td>
                                                    <td colspan="4">ที่อยู่ : <span style="padding-left:20px"><?php echo $address_home ?></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="3%"></td>
                                        ...
                                        <div class="panel-heading">
                                            <u><b>แผนที่แสดงตำแหน่งสถานประกอบการ</b></u>
                                        </div>
