        ...
        <div class="row " >
            <div class="col-md-10 col-md-offset-1">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> <a href="<?php echo base_url('teacher/showall'); ?> ">ข้อมูลนักศึกษาทั้งหมด</a>
                    </li>
                    <li class="active">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"> 
                        <form id="form1" name="form1" method="post" action="<?php echo base_url() . 'index.php/teacher/update' ?>">
                            <table class="table table-bordered">
                                <thead >
                                    <tr>
                                        <th colspan="2" class="bg-aqua-gradient">แก้ไขข้อมูลทั่วไปของนักศึกษา</th>
                                    </tr>
                                    <tr >
                                ...
                                <thead class="bg-info">
                                    <tr>
                                        <th colspan="2" class="bg-aqua-gradient">ชื่อที่อยู่ผู้ที่สามารถติดต่อได้ในกรณีฉุกเฉิน</th>
